...
os.environ["DB_URL"] = "postgres://admin:password@34.205.2.155:80/forum"
db_url = os.environ["DB_URL"]
engine = create_engine(db_url)
Session = sessionmaker(bind=engine)
session = Session()

from dbexport.models import Post, Comment
...
with open("./dbexport/forum_export.json", mode="w") as f:
   json.dump(items, f)
